...
def cifar10(data_dir, batch_size=32, mode="base", normalize=True, norm_layer=None, size=32):
    """
        mode: org | base | ssl
    """
    transform_train = [transforms.Resize(size),
...
def cifar100(data_dir, batch_size, mode="base", normalize=True, norm_layer=None, size=32):
    """
        mode: org | base | ssl
    """
    transform_train = [transforms.Resize(size), 
